test_that("piecewise interpolation works", {
  ...
  answer_tp <- c(6, 6.138, 6.276, 6.414, 6.552,
  ...
  answer_hz <- c(10, 11.379, 12.759, 14.138, 15.517,
                 ...
                 44.483, 45.862, 47.241, 48.621, 50, 10,
  ...
  expect_equal(unique(int_df$tstsec), c('later','earlier'))
